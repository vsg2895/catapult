    ...
    public function toArray($request)
    {
        return [
            ...
            'data' => [
                ...
                'task_status' => $this->data['task_status'] ?? null,
                'task_rewards' => $this->data['task_rewards'] ?? null,
                'project_name' => $this->data['project_name'] ?? null,
                'project_tags' => $this->data['project_tags'] ?? null,
                'manager_name' => $this->data['manager_name'] ?? null,
                'invitation_status' => $this->invitation_status,
                'project_blockchain' => $this->data['project_blockchain'] ?? null,
            ],
            'buttons' => [
