...
class NotificationController extends Controller
{
     ...
     *                          property="type",
     *                          type="string",
     *                          enum={"new_task", "task_status", "new_project", "invite_to_join"},
     *                          example="new_task",
     *                      ),
     *                      @OA\Property(
     *                          property="read",
     ...
     *                              type="string",
     *                              enum={"done", "returned", "rejected", "on_revision"},
     *                              example="on_revision",
     *                              nullable=true,
     *                          ),
     *                          @OA\Property(
     *                              property="task_rewards",
     *                              type="array",
     *                              nullable=true,
     *                              @OA\Items(type="string"),
     *                          ),
     *                          @OA\Property(property="manager_name", type="string", nullable=true),
     *                          @OA\Property(property="project_name", type="string", nullable=true),
     *                          @OA\Property(
     *                              property="project_tags",
     *                              type="array",
     *                              nullable=true,
     *                              @OA\Items(type="string"),
     *                          ),
     *                          @OA\Property(property="invitation_status", type="string", nullable=true),
     *                          @OA\Property(property="project_blockchain", type="string", nullable=true),
     *                      ),
     *                      @OA\Property(
     *                          property="buttons",
